...
-export([ americano/0, cappuccino/0, tea/0, espresso/0, pay/1, cancel/0, cup_removed/0 ]).
...
handle_sync_event(_Message, _From, State, Data) ->
...
handle_info(_Message, StateName, Data) ->
